...
if `=maxyear'>=2010 {
	if `=minyear5'<=1960 {
		...
		*/ ysc(range(`=minloggdppc'(0.1)`=maxloggdppc')) lwidth(medthick) ytitle("log(GDPPC)") || /*
		...
		*/ text(`=minloggdppc' 1962.5 "`g_1960'") text(`=minloggdppc' 1967.5 "`g_1965'") text(`=minloggdppc' 1972.5 "`g_1970'") /*
		*/ text(`=minloggdppc' 1977.5 "`g_1975'") text(`=minloggdppc' 1982.5 "`g_1980'") text(`=minloggdppc' 1987.5 "`g_1985'") /*
		*/ text(`=minloggdppc' 1992.5 "`g_1990'") text(`=minloggdppc' 1997.5 "`g_1995'") text(`=minloggdppc' 2002.5 "`g_2000'") /*
		*/ text(`=minloggdppc' 2007.5 "`g_2005'") /*
		*/ text(`=minloggdppc*1.005' `=maxyear-1' "`mingdppc'" "Min", j(right)) text(`=medloggdppc*1.01' `=maxyear-1' "`medgdppc'" "Med", j(right)) /*
		*/ text(`=maxloggdppc' `=maxyear-1' "`maxgdppc'" "Max", j(right)) /*
		*/ text(`=maxloggdppc*1.015' 1965 "g{subscript:60s}: `g1960'") text(`=maxloggdppc*1.015' 1975 "g{subscript:70s}: `g1970'") /*
		*/ text(`=maxloggdppc*1.015' 1985 "g{subscript:80s}: `g1980'") text(`=maxloggdppc*1.015' 1995 "g{subscript:90s}: `g1990'") /*
		*/ text(`=maxloggdppc*1.015' 2005 "g{subscript:00s}: `g2000'") /*
		*/ text(`=maxloggdppc*0.99' `=minyear5+3.0' "g: `g_all'" "R{superscript:2}: `r2'" "{&sigma}{subscript:{&Delta}y}: `sd'", j(left)) scale(0.9)
	}
		...
		*/ lfit loggdppc year if wbcode=="`ctry'", legend(off) lpattern(dash) lcolor(black) title("Overall, ten, and five year growth rates") /*
		*/ subtitle("`j'") note("Note: GDP per capita (constant 2005 US$), log" "Data source:  World Development Indicators") /*
		*/ text(`=minloggdppc' 1967.5 "`g_1965'") text(`=minloggdppc' 1972.5 "`g_1970'") text(`=minloggdppc' 1977.5 "`g_1975'") /*
		*/ text(`=minloggdppc' 1982.5 "`g_1980'") text(`=minloggdppc' 1987.5 "`g_1985'") text(`=minloggdppc' 1992.5 "`g_1990'") /*
		*/ text(`=minloggdppc' 1997.5 "`g_1995'") text(`=minloggdppc' 2002.5 "`g_2000'") text(`=minloggdppc' 2007.5 "`g_2005'") /*
		*/ text(`=minloggdppc*1.005' `=maxyear-1' "`mingdppc'" "Min", j(right)) text(`=medloggdppc*1.005' `=maxyear-1' "`medgdppc'" "Med", j(right)) /*
		*/ text(`=maxloggdppc' `=maxyear-1' "`maxgdppc'" "Max", j(right)) /*
		*/ text(`=maxloggdppc*1.015' 1975 "g{subscript:70s}: `g1970'") text(`=maxloggdppc*1.015' 1985 "g{subscript:80s}: `g1980'") /*
		*/ text(`=maxloggdppc*1.015' 1995 "g{subscript:90s}: `g1990'") text(`=maxloggdppc*1.015' 2005 "g{subscript:00s}: `g2000'") /*
		*/ text(`=maxloggdppc*0.99' `=minyear5+3.0' "g: `g_all'" "R{superscript:2}: `r2'" "{&sigma}{subscript:{&Delta}y}: `sd'", j(left)) scale(0.9)
	}
		...
		*/ lfit loggdppc year if wbcode=="`ctry'", legend(off) lpattern(dash) lcolor(black) title("Overall, ten, and five year growth rates") /*
		*/ subtitle("`j'") note("Note: GDP per capita (constant 2005 US$), log" "Data source:  World Development Indicators") /*
		*/ text(`=minloggdppc' 1972.5 "`g_1970'") text(`=minloggdppc' 1977.5 "`g_1975'") text(`=minloggdppc' 1982.5 "`g_1980'") /*
		*/ text(`=minloggdppc' 1987.5 "`g_1985'") text(`=minloggdppc' 1992.5 "`g_1990'") text(`=minloggdppc' 1997.5 "`g_1995'") /*
		*/ text(`=minloggdppc' 2002.5 "`g_2000'") text(`=minloggdppc' 2007.5 "`g_2005'") /*
		*/ text(`=minloggdppc*1.005' `=maxyear-1' "`mingdppc'" "Min", j(right)) text(`=medloggdppc*1.005' `=maxyear-1' "`medgdppc'" "Med", j(right)) /*
		*/ text(`=maxloggdppc' `=maxyear-1' "`maxgdppc'" "Max", j(right)) /*
		*/ text(`=maxloggdppc*1.015' 1975 "g{subscript:70s}: `g1970'") text(`=maxloggdppc*1.015' 1985 "g{subscript:80s}: `g1980'") /*
		*/ text(`=maxloggdppc*1.015' 1995 "g{subscript:90s}: `g1990'") text(`=maxloggdppc*1.015' 2005 "g{subscript:00s}: `g2000'") /*
		...
		*/ text(`=maxloggdppc*1.015' 1985 "g{subscript:80s}: `g1980'") text(`=maxloggdppc*1.015' 1995 "g{subscript:90s}: `g1990'") /*
		*/ text(`=maxloggdppc*1.015' 2005 "g{subscript:00s}: `g2000'") /*
		*/ text(`=maxloggdppc*0.99' `=minyear5+2.5' "g: `g_all'" "R{superscript:2}: `r2'" "{&sigma}{subscript:{&Delta}y}: `sd'", j(left)) scale(0.9)
	}
		...
		*/ text(`=minloggdppc' 1997.5 "`g_1995'") text(`=minloggdppc' 2002.5 "`g_2000'") text(`=minloggdppc' 2007.5 "`g_2005'") /*
		*/ text(`=minloggdppc*1.005' `=maxyear-1' "`mingdppc'" "Min", j(right)) text(`=medloggdppc*1.005' `=maxyear-1' "`medgdppc'" "Med", j(right)) /*
		*/ text(`=maxloggdppc' `=maxyear-1' "`maxgdppc'" "Max", j(right)) text(`=maxloggdppc*1.015' 1985 "g{subscript:80s}: `g1980'") /*
		*/ text(`=maxloggdppc*1.015' 1995 "g{subscript:90s}: `g1990'") text(`=maxloggdppc*1.015' 2005 "g{subscript:00s}: `g2000'") /*
		*/ text(`=maxloggdppc*0.99' `=minyear5+2.5' "g: `g_all'" "R{superscript:2}: `r2'" "{&sigma}{subscript:{&Delta}y}: `sd'", j(left)) scale(0.9)
	}
		...
		*/ text(`=maxloggdppc' `=maxyear-1' "`maxgdppc'" "Max", j(right)) /*
		*/ text(`=maxloggdppc*1.015' 1995 "g{subscript:90s}: `g1990'") text(`=maxloggdppc*1.015' 2005 "g{subscript:00s}: `g2000'") /*
		*/ text(`=maxloggdppc*0.99' `=minyear5+2.0' "g: `g_all'" "R{superscript:2}: `r2'" "{&sigma}{subscript:{&Delta}y}: `sd'", j(left)) scale(0.9)
	}
		...
		*/ text(`=minloggdppc' 1997.5 "`g_1995'") text(`=minloggdppc' 2002.5 "`g_2000'") text(`=minloggdppc' 2007.5 "`g_2005'") /*
		*/ text(`=minloggdppc*1.005' `=maxyear-1' "`mingdppc'" "Min", j(right)) text(`=medloggdppc*1.005' `=maxyear-1' "`medgdppc'" "Med", j(right)) /*
		*/ text(`=maxloggdppc' `=maxyear-1' "`maxgdppc'" "Max", j(right)) text(`=maxloggdppc*1.015' 2005 "g{subscript:00s}: `g2000'") /*
		*/ text(`=maxloggdppc*0.99' `=minyear5+1.5' "g: `g_all'" "R{superscript:2}: `r2'" "{&sigma}{subscript:{&Delta}y}: `sd'", j(left)) scale(0.9)
	}
		...
		*/ text(`=minloggdppc*1.005' `=maxyear-1' "`mingdppc'" "Min", j(right)) text(`=medloggdppc*1.005' `=maxyear-1' "`medgdppc'" "Med", j(right)) /*
		*/ text(`=maxloggdppc' `=maxyear-1' "`maxgdppc'" "Max", j(right)) /*
		*/ text(`=maxloggdppc*0.99' `=minyear5+1.0' "g: `g_all'" "R{superscript:2}: `r2'" "{&sigma}{subscript:{&Delta}y}: `sd'", j(left)) scale(0.9)
	}
		else {
		twoway line loggdppc year if wbcode=="`ctry'" & year>=`=minyear5', xlabel(`=minyear5'(5)`=maxyear') xsc(range(`=minyear5'(5)`=maxyear')) /*
		*/ ysc(range(`=minloggdppc'(0.1)`=maxloggdppc')) lwidth(medthick) ytitle("log(GDPPC)") || /*
	...
	if `=minyear5'<=1960 {
		...
		*/ text(`=maxloggdppc' `=maxyear-1' "`maxgdppc'" "Max", j(right)) text(`=maxloggdppc*1.015' 1965 "g{subscript:60s}: `g1960'") /*
		*/ text(`=maxloggdppc*1.015' 1975 "g{subscript:70s}: `g1970'") text(`=maxloggdppc*1.015' 1985 "g{subscript:80s}: `g1980'") /*
		*/ text(`=maxloggdppc*1.015' 1995 "g{subscript:90s}: `g1990'") /*
		*/ text(`=maxloggdppc*0.99' `=minyear5+3.0' "g: `g_all'" "R{superscript:2}: `r2'" "{&sigma}{subscript:{&Delta}y}: `sd'", j(left)) scale(0.9)
	}
	else if `=minyear5'>1960 & `=minyear5'<=1965 {
		twoway line loggdppc year if wbcode=="`ctry'" & year>=`=minyear5', xlabel(`=minyear5'(5)`=maxyear') xsc(range(`=minyear5'(5)`=maxyear')) /*
		...
		*/ text(`=minloggdppc' 1967.5 "`g_1965'") text(`=minloggdppc' 1972.5 "`g_1970'") text(`=minloggdppc' 1977.5 "`g_1975'") /*
		*/ text(`=minloggdppc' 1982.5 "`g_1980'") text(`=minloggdppc' 1987.5 "`g_1985'") text(`=minloggdppc' 1992.5 "`g_1990'") /*
		*/ text(`=minloggdppc' 1997.5 "`g_1995'") text(`=minloggdppc' 2002.5 "`g_2000'") text(`=minloggdppc' `=maxyear-1' "`mingdppc'" "Min", j(right)) /*
		...
		*/ text(`=minloggdppc' 1972.5 "`g_1970'") text(`=minloggdppc' 1977.5 "`g_1975'") text(`=minloggdppc' 1982.5 "`g_1980'") /*
		*/ text(`=minloggdppc' 1987.5 "`g_1985'") text(`=minloggdppc' 1992.5 "`g_1990'") text(`=minloggdppc' 1997.5 "`g_1995'") /*
		*/ text(`=minloggdppc' 2002.5 "`g_2000'") /*
		*/ text(`=minloggdppc*1.005' `=maxyear-1' "`mingdppc'" "Min", j(right)) text(`=medloggdppc*1.005' `=maxyear-1' "`medgdppc'" "Med", j(right)) /*
		*/ text(`=maxloggdppc' `=maxyear-1' "`maxgdppc'" "Max", j(right)) /*
		*/ text(`=maxloggdppc*1.015' 1975 "g{subscript:70s}: `g1970'") text(`=maxloggdppc*1.015' 1985 "g{subscript:80s}: `g1980'") /*
		*/ text(`=maxloggdppc*1.015' 1995 "g{subscript:90s}: `g1990'") /*
		...
		*/ subtitle("`j'") note("Note: GDP per capita (constant 2005 US$), log" "Data source:  World Development Indicators") /*
		*/ text(`=minloggdppc' 1982.5 "`g_1980'") text(`=minloggdppc' 1987.5 "`g_1985'") text(`=minloggdppc' 1992.5 "`g_1990'") /*
		*/ text(`=minloggdppc' 1997.5 "`g_1995'") text(`=minloggdppc' 2002.5 "`g_2000'") /*
		*/ text(`=minloggdppc*1.005' `=maxyear-1' "`mingdppc'" "Min", j(right)) text(`=medloggdppc*1.005' `=maxyear-1' "`medgdppc'" "Med", j(right)) /*
		*/ text(`=maxloggdppc' `=maxyear-1' "`maxgdppc'" "Max", j(right)) /*
		*/ text(`=maxloggdppc*1.015' 1985 "g{subscript:80s}: `g1980'") text(`=maxloggdppc*1.015' 1995 "g{subscript:90s}: `g1990'") /*
		*/ text(`=maxloggdppc*0.99' `=minyear5+2.5' "g: `g_all'" "R{superscript:2}: `r2'" "{&sigma}{subscript:{&Delta}y}: `sd'", j(left)) scale(0.9)
		...
		*/ text(`=minloggdppc' 1992.5 "`g_1990'") text(`=minloggdppc' 1997.5 "`g_1995'") text(`=minloggdppc' 2002.5 "`g_2000'") /*
		*/ text(`=minloggdppc*1.005' `=maxyear-1' "`mingdppc'" "Min", j(right)) text(`=medloggdppc*1.005' `=maxyear-1' "`medgdppc'" "Med", j(right)) /*
		*/ text(`=maxloggdppc' `=maxyear-1' "`maxgdppc'" "Max", j(right)) text(`=maxloggdppc*1.015' 1995 "g{subscript:90s}: `g1990'") /*
		*/ text(`=maxloggdppc*0.99' `=minyear5+2.0' "g: `g_all'" "R{superscript:2}: `r2'" "{&sigma}{subscript:{&Delta}y}: `sd'", j(left)) scale(0.9)
	}
		else if `=minyear5'>1990 & `=minyear5'<=1995 {
		twoway line loggdppc year if wbcode=="`ctry'" & year>=`=minyear5', xlabel(`=minyear5'(5)`=maxyear') xsc(range(`=minyear5'(5)`=maxyear')) /*
		...
		*/ subtitle("`j'") note("Note: GDP per capita (constant 2005 US$), log" "Data source:  World Development Indicators") /*
		*/ text(`=minloggdppc' 1997.5 "`g_1995'") text(`=minloggdppc' 2002.5 "`g_2000'") /*
		*/ text(`=minloggdppc*1.005' `=maxyear' "`mingdppc'" "Min", j(right)) text(`=medloggdppc*1.005' `=maxyear-1' "`medgdppc'" "Med", j(right)) /*
		*/ text(`=maxloggdppc' `=maxyear' "`maxgdppc'" "Max", j(right)) /*
		*/ text(`=maxloggdppc*0.99' `=minyear5+1.5' "g: `g_all'" "R{superscript:2}: `r2'" "{&sigma}{subscript:{&Delta}y}: `sd'", j(left)) scale(0.9)
	}
		else if `=minyear5'>1995 & `=minyear5'<=2000 {
		twoway line loggdppc year if wbcode=="`ctry'" & year>=`=minyear5', xlabel(`=minyear5'(5)`=maxyear') xsc(range(`=minyear5'(5)`=maxyear')) /*
		...
		*/ lfit loggdppc year if wbcode=="`ctry'", legend(off) lpattern(dash) lcolor(black) title("Overall, ten, and five year growth rates") /*
		*/ subtitle("`j'") note("Note: GDP per capita (constant 2005 US$), log" "Data source:  World Development Indicators") /*
		*/ text(`=minloggdppc*1.005' `=maxyear-1.0' "`mingdppc'" "Min", j(right)) text(`=medloggdppc*1.005' `=maxyear-1.0' "`medgdppc'" "Med", j(right)) /*
...
preserve
drop if wbcode!="`ctry'"
merge 1:1 wbcode country year using "wdi_ctry"
...
foreach x in min max {
	xtile pct`=`x'year2'=gdppc2`=`x'year2' if gdppc2`=`x'year2'!=., nq(10)
...
*/ function y=x, range(2.5 4.6) lc(gs8) || function y=x+0.43429448, range(2.5 4.4) lc(gs8) || function y=x+0.86858896, range(2.5 4.15) lc(gs8) legend(off) /*
*/ xsc(range(2.5(0.5)5)) xlabel(2.5(0.5)5) ysc(range(2.5(0.5)5)) ylabel(2.5(0.5)5) text(4.6 4.8 "0% growth") text(4.8 4.6 "2% growth") text(5 4.3 "4% growth") /*
...
*/ text(3.25 3.75 "`=minyear2'" "`=maxyear2'" "Ratio") text(3.6 4 "`ctry'" ) text(3.32 3.95 "`y_min'" "`y_max'") text(3.1 3.95 "`ratio'") /*
*/ text(3.6 4.25 "Rank") text(3.32 4.25 "`=rank`=minyear2''/`=n_min'" "`=rank`=maxyear2''/`=n_max'", j(left)) /*
*/ text(3.6 4.5 "Decile") text(3.32 4.4 "`pct_min'" "`pct_max'")
