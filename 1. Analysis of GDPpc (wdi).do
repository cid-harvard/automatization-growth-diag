...
summ year if wbcode=="`ctry'" & lngdppc!=.
	* Minimum
...
summ year if wbcode=="`ctry'" & lngdppc2!=.
	* Minimum
...
reg lngdppc year if wbcode=="`ctry'", robust
...
if `=maxyear'>=2010 {
	if `=minyear5'<=1960 {
		twoway line lngdppc year if wbcode=="`ctry'" & year>=`=minyear5', xlabel(`=minyear5'(5)`=maxyear') xsc(range(`=minyear5'(5)`=maxyear')) /*
		*/ ysc(range(`=minlngdppc-0.2'(0.2)`=maxlngdppc+0.6')) ylabel(#`rangelngdppc') lwidth(medthick) ytitle(Ln(GDPPC)) || /*
		*/ lfit lngdppc year if wbcode=="`ctry'", legend(off) lpattern(dash) lcolor(black) title("Overall, ten, and five year growth rates") /*
		*/ subtitle("`j'") note("Note: GDP per capita (constant 2005 US$)" "Data source:  World Development Indicators") /*
		...
		*/ text(`=minlngdppc-0.2' 2007.5 "`g_2005'") text(`=minlngdppc' `=maxyear-1' "`mingdppc'" "Min", j(right)) /*
		*/ text(`=medlngdppc' `=maxyear-1' "`medgdppc'" "Med", j(right)) text(`=maxlngdppc' `=maxyear-1' "`maxgdppc'" "Max", j(right)) /*
		...
		*/ text(`=maxlngdppc+0.2' `=minyear5+3.0' "g: `g_all'" "R{superscript:2}: `r2'" "{&sigma}{subscript:{&Delta}y}: `sd'", j(left)) scale(0.9)
	}
		...
		*/ lfit lngdppc year if wbcode=="`ctry'", legend(off) lpattern(dash) lcolor(black) title("Overall, ten, and five year growth rates") /*
		*/ subtitle("`j'") note("Note: GDP per capita (constant 2005 US$)" "Data source:  World Development Indicators") /*
		*/ text(`=minlngdppc-0.2' 1967.5 "`g_1965'") text(`=minlngdppc-0.2' 1972.5 "`g_1970'") text(`=minlngdppc-0.2' 1977.5 "`g_1975'") /*
		*/ text(`=minlngdppc-0.2' 1982.5 "`g_1980'") text(`=minlngdppc-0.2' 1987.5 "`g_1985'") text(`=minlngdppc-0.2' 1992.5 "`g_1990'") /*
		*/ text(`=minlngdppc-0.2' 1997.5 "`g_1995'") text(`=minlngdppc-0.2' 2002.5 "`g_2000'") text(`=minlngdppc-0.2' 2007.5 "`g_2005'") /*
		*/ text(`=minlngdppc' `=maxyear-1' "`mingdppc'" "Min", j(right)) text(`=medlngdppc' `=maxyear-1' "`medgdppc'" "Med", j(right)) /*
		*/ text(`=maxlngdppc' `=maxyear-1' "`maxgdppc'" "Max", j(right)) text(`=maxlngdppc+0.4' 1975 "g{subscript:70s}: `g1970'") /*
		*/ text(`=maxlngdppc+0.4' 1985 "g{subscript:80s}: `g1980'") text(`=maxlngdppc+0.4' 1995 "g{subscript:90s}: `g1990'") /*
		*/ text(`=maxlngdppc+0.4' 2005 "g{subscript:00s}: `g2000'") /*
		*/ text(`=maxlngdppc+0.2' `=minyear5+3.0' "g: `g_all'" "R{superscript:2}: `r2'" "{&sigma}{subscript:{&Delta}y}: `sd'", j(left)) scale(0.9)
	}
		...
		*/ lfit lngdppc year if wbcode=="`ctry'", legend(off) lpattern(dash) lcolor(black) title("Overall, ten, and five year growth rates") /*
		*/ subtitle("`j'") note("Note: GDP per capita (constant 2005 US$)" "Data source:  World Development Indicators") /*
		*/ text(`=minlngdppc-0.2' 1972.5 "`g_1970'") text(`=minlngdppc-0.2' 1977.5 "`g_1975'") text(`=minlngdppc-0.2' 1982.5 "`g_1980'") /*
		*/ text(`=minlngdppc-0.2' 1987.5 "`g_1985'") text(`=minlngdppc-0.2' 1992.5 "`g_1990'") text(`=minlngdppc-0.2' 1997.5 "`g_1995'") /*
		*/ text(`=minlngdppc-0.2' 2002.5 "`g_2000'") text(`=minlngdppc-0.2' 2007.5 "`g_2005'") text(`=minlngdppc' `=maxyear-1' "`mingdppc'" "Min", j(right)) /*
		*/ text(`=medlngdppc' `=maxyear-1' "`medgdppc'" "Med", j(right)) text(`=maxlngdppc' `=maxyear-1' "`maxgdppc'" "Max", j(right)) /*
		*/ text(`=maxlngdppc+0.4' 1975 "g{subscript:70s}: `g1970'") text(`=maxlngdppc+0.4' 1985 "g{subscript:80s}: `g1980'") /*
		*/ text(`=maxlngdppc+0.4' 1995 "g{subscript:90s}: `g1990'") text(`=maxlngdppc+0.4' 2005 "g{subscript:00s}: `g2000'") /*
		*/ text(`=maxlngdppc+0.2' `=minyear5+3.0' "g: `g_all'" "R{superscript:2}: `r2'" "{&sigma}{subscript:{&Delta}y}: `sd'", j(left)) scale(0.9)
	}
		...
		*/ text(`=maxlngdppc+0.4' 1985 "g{subscript:80s}: `g1980'") text(`=maxlngdppc+0.4' 1995 "g{subscript:90s}: `g1990'") /*
		*/ text(`=maxlngdppc+0.4' 2005 "g{subscript:00s}: `g2000'") /*
		*/ text(`=maxlngdppc+0.2' `=minyear5+2.5' "g: `g_all'" "R{superscript:2}: `r2'" "{&sigma}{subscript:{&Delta}y}: `sd'", j(left)) scale(0.9)
	}
		...
		*/ text(`=minlngdppc-0.2' 1997.5 "`g_1995'") text(`=minlngdppc-0.2' 2002.5 "`g_2000'") text(`=minlngdppc-0.2' 2007.5 "`g_2005'") /*
		*/ text(`=minlngdppc' `=maxyear-1' "`mingdppc'" "Min", j(right)) text(`=medlngdppc' `=maxyear-1' "`medgdppc'" "Med", j(right)) /*
		*/ text(`=maxlngdppc' `=maxyear-1' "`maxgdppc'" "Max", j(right)) text(`=maxlngdppc+0.4' 1985 "g{subscript:80s}: `g1980'") /*
		*/ text(`=maxlngdppc+0.4' 1995 "g{subscript:90s}: `g1990'") text(`=maxlngdppc+0.4' 2005 "g{subscript:00s}: `g2000'") /*
		*/ text(`=maxlngdppc+0.2' `=minyear5+2.5' "g: `g_all'" "R{superscript:2}: `r2'" "{&sigma}{subscript:{&Delta}y}: `sd'", j(left)) scale(0.9)
	}
		...
		*/ text(`=medlngdppc' `=maxyear-1' "`medgdppc'" "Med", j(right)) text(`=maxlngdppc' `=maxyear-1' "`maxgdppc'" "Max", j(right)) /*
		*/ text(`=maxlngdppc+0.4' 1995 "g{subscript:90s}: `g1990'") text(`=maxlngdppc+0.4' 2005 "g{subscript:00s}: `g2000'") /*
		*/ text(`=maxlngdppc+0.2' `=minyear5+2.0' "g: `g_all'" "R{superscript:2}: `r2'" "{&sigma}{subscript:{&Delta}y}: `sd'", j(left)) scale(0.9)
	}
		...
		*/ text(`=minlngdppc-0.2' 1997.5 "`g_1995'") text(`=minlngdppc-0.2' 2002.5 "`g_2000'") text(`=minlngdppc-0.2' 2007.5 "`g_2005'") /*
		*/ text(`=minlngdppc' `=maxyear-1' "`mingdppc'" "Min", j(right)) text(`=medlngdppc' `=maxyear-1' "`medgdppc'" "Med", j(right)) /*
		*/ text(`=maxlngdppc' `=maxyear-1' "`maxgdppc'" "Max", j(right)) text(`=maxlngdppc+0.4' 2005 "g{subscript:00s}: `g2000'") /*
		*/ text(`=maxlngdppc+0.2' `=minyear5+1.5' "g: `g_all'" "R{superscript:2}: `r2'" "{&sigma}{subscript:{&Delta}y}: `sd'", j(left)) scale(0.9)
	}
		...
		*/ text(`=minlngdppc-0.2' 2007.5 "`g_2005'") text(`=minlngdppc' `=maxyear-1' "`mingdppc'" "Min", j(right)) /*
		*/ text(`=medlngdppc' `=maxyear-1' "`medgdppc'" "Med", j(right)) text(`=maxlngdppc' `=maxyear-1' "`maxgdppc'" "Max", j(right)) /*
		*/ text(`=maxlngdppc+0.2' `=minyear5+1.0' "g: `g_all'" "R{superscript:2}: `r2'" "{&sigma}{subscript:{&Delta}y}: `sd'", j(left)) scale(0.9)
	}
		else {
		twoway line lngdppc year if wbcode=="`ctry'" & year>=`=minyear5', xlabel(`=minyear5'(5)`=maxyear') xsc(range(`=minyear5'(5)`=maxyear')) /*
		*/ ysc(range(`=minlngdppc-0.2'(0.2)`=maxlngdppc+0.6')) ylabel(#`rangelngdppc') lwidth(medthick) ytitle(Ln(GDPPC)) || /*
		...
		*/ subtitle("`j'") note("Note: GDP per capita (constant 2005 US$)" "Data source:  World Development Indicators") /*
		*/ text(`=minlngdppc' `=maxyear-1' "`mingdppc'" "Min", j(right)) text(`=medlngdppc' `=maxyear-1' "`medgdppc'" "Med", j(right)) /*
		*/ text(`=maxlngdppc' `=maxyear-1' "`maxgdppc'" "Max", j(right)) /*
		*/ text(`=maxlngdppc+0.2' `=minyear5+1.0' "g: `g_all'" "R{superscript:2}: `r2'" "{&sigma}{subscript:{&Delta}y}: `sd'", j(left)) scale(0.9)
	}
}
else {
	if `=minyear5'<=1960 {
		...
		*/ text(`=minlngdppc-0.2' 1992.5 "`g_1990'") text(`=minlngdppc-0.2' 1997.5 "`g_1995'") text(`=minlngdppc-0.2' 2002.5 "`g_2000'") /*
		*/ text(`=minlngdppc' `=maxyear-1' "`mingdppc'" "Min", j(right)) text(`=medlngdppc' `=maxyear-1' "`medgdppc'" "Med", j(right)) /*
		*/ text(`=maxlngdppc' `=maxyear-1' "`maxgdppc'" "Max", j(right)) text(`=maxlngdppc+0.4' 1965 "g{subscript:60s}: `g1960'") /*
		*/ text(`=maxlngdppc+0.4' 1975 "g{subscript:70s}: `g1970'") text(`=maxlngdppc+0.4' 1985 "g{subscript:80s}: `g1980'") /*
		*/ text(`=maxlngdppc+0.4' 1995 "g{subscript:90s}: `g1990'") /*
		*/ text(`=maxlngdppc+0.2' `=minyear5+3.0' "g: `g_all'" "R{superscript:2}: `r2'" "{&sigma}{subscript:{&Delta}y}: `sd'", j(left)) scale(0.9)
	}
	else if `=minyear5'>1960 & `=minyear5'<=1965 {
		twoway line lngdppc year if wbcode=="`ctry'" & year>=`=minyear5', xlabel(`=minyear5'(5)`=maxyear') xsc(range(`=minyear5'(5)`=maxyear')) /*
		...
		*/ text(`=minlngdppc-0.2' 1967.5 "`g_1965'") text(`=minlngdppc-0.2' 1972.5 "`g_1970'") text(`=minlngdppc-0.2' 1977.5 "`g_1975'") /*
		*/ text(`=minlngdppc-0.2' 1982.5 "`g_1980'") text(`=minlngdppc-0.2' 1987.5 "`g_1985'") text(`=minlngdppc-0.2' 1992.5 "`g_1990'") /*
		*/ text(`=minlngdppc-0.2' 1997.5 "`g_1995'") text(`=minlngdppc-0.2' 2002.5 "`g_2000'") text(`=minlngdppc' `=maxyear-1' "`mingdppc'" "Min", j(right)) /*
		*/ text(`=medlngdppc' `=maxyear-1' "`medgdppc'" "Med", j(right)) text(`=maxlngdppc' `=maxyear-1' "`maxgdppc'" "Max", j(right)) /*
		*/ text(`=maxlngdppc+0.4' 1975 "g{subscript:70s}: `g1970'") text(`=maxlngdppc+0.4' 1985 "g{subscript:80s}: `g1980'") /*
		*/ text(`=maxlngdppc+0.4' 1995 "g{subscript:90s}: `g1990'") /*
		*/ text(`=maxlngdppc+0.2' `=minyear5+3.0' "g: `g_all'" "R{superscript:2}: `r2'" "{&sigma}{subscript:{&Delta}y}: `sd'", j(left)) scale(0.9)
		...
		*/ text(`=minlngdppc-0.2' 1972.5 "`g_1970'") text(`=minlngdppc-0.2' 1977.5 "`g_1975'") text(`=minlngdppc-0.2' 1982.5 "`g_1980'") /*
		*/ text(`=minlngdppc-0.2' 1987.5 "`g_1985'") text(`=minlngdppc-0.2' 1992.5 "`g_1990'") text(`=minlngdppc-0.2' 1997.5 "`g_1995'") /*
		*/ text(`=minlngdppc-0.2' 2002.5 "`g_2000'") text(`=minlngdppc' `=maxyear-1' "`mingdppc'" "Min", j(right)) /*
		*/ text(`=medlngdppc' `=maxyear-1' "`medgdppc'" "Med", j(right)) text(`=maxlngdppc' `=maxyear-1' "`maxgdppc'" "Max", j(right)) /*
		*/ text(`=maxlngdppc+0.4' 1975 "g{subscript:70s}: `g1970'") text(`=maxlngdppc+0.4' 1985 "g{subscript:80s}: `g1980'") /*
		*/ text(`=maxlngdppc+0.4' 1995 "g{subscript:90s}: `g1990'") /*
		*/ text(`=maxlngdppc+0.2' `=minyear5+3.0' "g: `g_all'" "R{superscript:2}: `r2'" "{&sigma}{subscript:{&Delta}y}: `sd'", j(left)) scale(0.9)
		...
		*/ text(`=minlngdppc-0.2' 1992.5 "`g_1990'") text(`=minlngdppc-0.2' 1997.5 "`g_1995'") text(`=minlngdppc-0.2' 2002.5 "`g_2000'") /*
		*/ text(`=minlngdppc' `=maxyear-1' "`mingdppc'" "Min", j(right)) text(`=medlngdppc' `=maxyear-1' "`medgdppc'" "Med", j(right)) /*
		*/ text(`=maxlngdppc' `=maxyear-1' "`maxgdppc'" "Max", j(right)) text(`=maxlngdppc+0.4' 1995 "g{subscript:90s}: `g1990'") /*
		*/ text(`=maxlngdppc+0.2' `=minyear5+2.0' "g: `g_all'" "R{superscript:2}: `r2'" "{&sigma}{subscript:{&Delta}y}: `sd'", j(left)) scale(0.9)
	}
		else if `=minyear5'>1990 & `=minyear5'<=1995 {
		twoway line lngdppc year if wbcode=="`ctry'" & year>=`=minyear5', xlabel(`=minyear5'(5)`=maxyear') xsc(range(`=minyear5'(5)`=maxyear')) /*
		...
		*/ lfit lngdppc year if wbcode=="`ctry'", legend(off) lpattern(dash) lcolor(black) title("Overall, ten, and five year growth rates") /*
		*/ subtitle("`j'") note("Note: GDP per capita (constant 2005 US$)" "Data source:  World Development Indicators") /*
		*/ text(`=minlngdppc-0.2' 1997.5 "`g_1995'") text(`=minlngdppc-0.2' 2002.5 "`g_2000'") text(`=minlngdppc' `=maxyear' "`mingdppc'" "Min", j(right)) /*
		*/ text(`=medlngdppc' `=maxyear-1' "`medgdppc'" "Med", j(right)) text(`=maxlngdppc' `=maxyear' "`maxgdppc'" "Max", j(right)) /*
		*/ text(`=maxlngdppc+0.2' `=minyear5+1.5' "g: `g_all'" "R{superscript:2}: `r2'" "{&sigma}{subscript:{&Delta}y}: `sd'", j(left)) scale(0.9)
	}
		else if `=minyear5'>1995 & `=minyear5'<=2000 {
		twoway line lngdppc year if wbcode=="`ctry'" & year>=`=minyear5', xlabel(`=minyear5'(5)`=maxyear') xsc(range(`=minyear5'(5)`=maxyear')) /*
		...
		*/ lfit lngdppc year if wbcode=="`ctry'", legend(off) lpattern(dash) lcolor(black) title("Overall, ten, and five year growth rates") /*
		*/ subtitle("`j'") note("Note: GDP per capita (constant 2005 US$)" "Data source:  World Development Indicators") /*
		*/ text(`=minlngdppc' `=maxyear-1.0' "`mingdppc'" "Min", j(right)) text(`=medlngdppc' `=maxyear-1.0' "`medgdppc'" "Med", j(right)) /*
		*/ text(`=maxlngdppc' `=maxyear-1.0' "`maxgdppc'" "Max", j(right)) /*
		*/ text(`=maxlngdppc+0.2' `=minyear5+1.0' "g: `g_all'" "R{superscript:2}: `r2'" "{&sigma}{subscript:{&Delta}y}: `sd'", j(left)) scale(0.9)
	}
		else {
		twoway line lngdppc year if wbcode=="`ctry'" & year>=`=minyear5', xlabel(`=minyear5'(5)`=maxyear') xsc(range(`=minyear5'(5)`=maxyear')) /*
...
*/ note("Note: GDP per capita (constant 2005 US$)" "Data source:  World Development Indicators") 
...
*/  note("Note: GDP per capita (constant 2005 US$)" "Data source:  World Development Indicators") ylabel(, format(%9.1fc)) /*
...
* Final recovery
*gen recover=1 if gdppc[_n]>=pre_gdp[_n-1] & wbcode[_n]==wbcode[_n-1]

* Local minima
*gen minima=.
*replace minima=1 if gdppc[_n]<gdppc[_n-1] & gdppc[_n]<gdppc[_n+1]
...
* Max lngdppc
gen max_lngdppc=`=maxlngdppc' if wbcode=="`ctry'"
...
if `=number_milestones'==1 {
	twoway line lngdppc year if wbcode=="`ctry'", lwidth(medthick) || /*
	*/ spike max_lngdppc year if wbcode=="`ctry'" & milestone==1, lcolor(gs8) /*
	*/ xlabel(`=minyear'(5)`=maxyear') xsc(range(`=minyear'(5)`=maxyear')) /*
	*/ ysc(range(`=minlngdppc'(0.2)`=maxlngdppc')) ytitle(Ln(GDPPC)) /*
	*/ legend(off) title("Growth Accelerations and Collapses") subtitle("`j'") /*
	*/ note("Note: GDP per capita (constant 2005 US$)" "Data source:  World Development Indicators") /*
	*/ text(`=maxlngdppc' `=year1' "g{subscript:1}:`growth_1'" "") /*
	*/ text(`=maxlngdppc' `=year2' "g{subscript:2}:`growth_2'" "{&Delta}g:`delta_2'")
}
	...
	*/ text(`=maxlngdppc' `=year1' "g{subscript:1}:`growth_1'" "") /*
	*/ text(`=maxlngdppc' `=year2' "g{subscript:2}:`growth_2'" "{&Delta}g:`delta_2'") /*
	*/ text(`=maxlngdppc' `=year3' "g{subscript:3}:`growth_3'" "{&Delta}g:`delta_3'")
}
	...
	*/ text(`=maxlngdppc' `=year2' "g{subscript:2}:`growth_2'" "{&Delta}g:`delta_2'") /*
	*/ text(`=maxlngdppc' `=year3' "g{subscript:3}:`growth_3'" "{&Delta}g:`delta_3'") /*
	*/ text(`=maxlngdppc' `=year4' "g{subscript:4}:`growth_4'" "{&Delta}g:`delta_4'")
}
	...
	*/ text(`=maxlngdppc' `=year3' "g{subscript:3}:`growth_3'" "{&Delta}g:`delta_3'") /*
	*/ text(`=maxlngdppc' `=year4' "g{subscript:4}:`growth_4'" "{&Delta}g:`delta_4'") /*
	*/ text(`=maxlngdppc' `=year5' "g{subscript:5}:`growth_5'" "{&Delta}g:`delta_5'")
}
	...
	*/ text(`=maxlngdppc' `=year4' "g{subscript:4}:`growth_4'" "{&Delta}g:`delta_4'") /*
	*/ text(`=maxlngdppc' `=year5' "g{subscript:5}:`growth_5'" "{&Delta}g:`delta_5'") /*
	*/ text(`=maxlngdppc' `=year6' "g{subscript:6}:`growth_6'" "{&Delta}g:`delta_6'")
}
	...
	*/ text(`=maxlngdppc' `=year5' "g{subscript:5}:`growth_5'" "{&Delta}g:`delta_5'") /*
	*/ text(`=maxlngdppc' `=year6' "g{subscript:6}:`growth_6'" "{&Delta}g:`delta_6'") /*
	*/ text(`=maxlngdppc' `=year7' "g{subscript:7}:`growth_7'" "{&Delta}g:`delta_7'")
}
else {
	twoway line lngdppc year if wbcode=="`ctry'", lwidth(medthick) || /*
	*/ spike max_lngdppc year if wbcode=="`ctry'" & milestone==1, lcolor(gs8) /*
...
* Reshape and labels
keep region year wbcode country lngdppc gdppc lngdppc2 gdppc2 g
reshape wide lngdppc gdppc lngdppc2 gdppc2 g, i(wbcode) j(year)
label var lngdppc2`=maxyear2' "Level of GDPPC, `=maxyear'"
label var lngdppc2`=minyear2' "Level of GDPPC, `=minyear'"
summ lngdppc2`=minyear2'
summ lngdppc2`=maxyear2'
...
* Figure 2
twoway scatter lngdppc2`=maxyear2' lngdppc2`=minyear2' || /*
*/ scatter lngdppc2`=maxyear2' lngdppc2`=minyear2' if wbcode=="`ctry'", mlabel(wbcode) mlabsize(vsmall) mcolor(red) mlabcolor(red) mlabposition(3) || /*
*/ scatter lngdppc2`=maxyear2' lngdppc2`=minyear2' if region==`=region`ctry'' & wbcode!="`ctry'", mlabel(wbcode) mlabsize(vsmall) mcolor(orange) mlabcolor(orange) mlabposition(3) || /*
...
*/ ytitle("Level of GDPPC, `=maxyear2'") xtitle("Level of GDPPC, `=minyear2'") title("Initial and final level of GDP per capita") subtitle("`j'") /*
*/ note("Note: GDP per capita, PPP (constant 2005 international $)" "Data source: World Development Indicators") /*
...
gen g_all=(((gdppc`=maxyear2'/gdppc`=minyear2')^(1/(`=maxyear2'-`=minyear2')))-1)*100
format g_all %9.1fc
 
* Figure 2.1 (EXTRA)
lpoly g_all lngdppc2`=minyear2', ci at(lngdppc2`=minyear2') legend(off)  /*
*/ ytitle("Growth rate, `=minyear2'-`=maxyear2'") xtitle("Level of GDPPC, `=minyear2'") title("Overall growth rate and initial level of GDP per capita") /*
*/ subtitle("`j'") note("Note: GDP per capita, PPP (constant 2005 international $)" "Data source:  World Development Indicators") /*
*/ addplot(scatter g_all lngdppc2`=minyear2', mlabsize(vsmall) mcolor(edkblue) mlabcolor(edkblue) || /*
*/ scatter g_all lngdppc2`=minyear2' if region==`=region`ctry'', mlabel(wbcode) mlabsize(vsmall) mcolor(orange) mlabcolor(orange) mlabposition(3) || /*
*/ scatter g_all lngdppc2`=minyear2' if wbcode=="`ctry'", mlabel(wbcode) mlabsize(vsmall) mcolor(red) mlabcolor(red) mlabposition(3))

* Exporting results into word document
gr export "$dir\figure21`ctry'.png", height(548) width(753) replace
png2rtf using "$dir\analysis`ctry'.doc", g("$dir\figure21`ctry'.png") append
